...
/**
 * uci_has_pending_segment - Get last UCI pbf status and reset status.
 *
 * Note: This is called from Power Management to delay deep sleep.
 * Return true if last packet was segmented, false otherwise.
 */
bool uci_has_pending_segment(void);
