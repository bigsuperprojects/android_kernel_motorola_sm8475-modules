...
int qm358xx_rom_probe_device(struct qmrom_handle *handle)
{
	...
	/* Set rom ops */
	handle->qm35xxx_rom_ops.gen_secrets = gen_secrets;
	handle->qm35xxx_rom_ops.load_asset_pkg = load_asset_pkg;
	handle->qm35xxx_rom_ops.load_fw_pkg = load_fw_pkg;
	handle->qm35xxx_rom_ops.load_secure_dbg_pkg = load_secure_debug_pkg;
	handle->qm35xxx_rom_ops.erase_secure_dbg_pkg = erase_secure_debug_pkg;
	handle->qm35xxx_rom_ops.load_sram_fw = load_sram_fw;
	handle->qm35xxx_rom_ops.run_test_mode = run_test_mode;
...
static void dump_stats(void)
{
	LOG_WARN(
		...
		total_bytes, div_u64(total_time_ns, 1000), CHUNK_SIZE,
